c$Header: /data/petsun4/data1/src_solaris/librms/RCS/fftsol.f,v 1.5 2013/09/14 23:51:23 avi Exp $
c$Log: fftsol.f,v $
c Revision 1.5  2013/09/14  23:51:23  avi
c correct documentation of 3d fft
c
c Revision 1.4  2009/02/17  07:37:15  avi
c maxfp 97->511
c
c Revision 1.3  2007/08/09  01:03:21  avi
c make maxf a parameter and increase value 23 -> 97
c on array bound limit exceed call exit(-1)
c
...
c  array storage for maximum prime factor of maxfp
      parameter (maxfp=511)
      dimension at(maxfp),bt(maxfp),ck(maxfp),sk(maxfp)
      equivalence (i,ii)
