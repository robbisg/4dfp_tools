c $Header: /data/petsun4/data1/src_solaris/imgblur_4dfp/RCS/fimgblur.f,v 1.4 2013/05/31 03:41:55 avi Exp $
c $Log: fimgblur.f,v $
c Revision 1.4  2013/05/31  03:41:55  avi
c suppress rcs message on each call
c
...
c
      ...
      write(*,"('$Id: fimgblur.f,v 1.4 2013/05/31 03:41:55 avi Exp $')")
      return
      end
