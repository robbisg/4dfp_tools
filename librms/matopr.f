...
c Copyright 1996, 1997, 1998, 1999, 2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010,
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c $Header: /data/petsun4/data1/src_solaris/librms/RCS/matopr.f,v 1.5 2014/05/19 07:00:50 avi Exp $
c $Log: matopr.f,v $
c Revision 1.5  2014/05/19  07:00:50  avi
c remove determ() as it is in polfit.f
c
c Revision 1.4  2014/03/23  07:31:16  avi
c subroutine determ(a,n,d)
c
...
C     McGraw-Hill, New York, 1969.
      ...
      if(N.gt.512)stop 'matinv matrix dimension limit (512) exceded'
      D=1.
      DO 100 K=1,N
      AMAX=0.
   21 DO 30 I=K,N
