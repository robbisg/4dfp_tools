/*$Header: /data/petsun4/data1/src_solaris/librms/RCS/librms.h,v 1.4 2014/03/23 07:31:46 avi Exp $*/
/*$Log: librms.h,v $
 * Revision 1.4  2014/03/23  07:31:46  avi
 * void determ_ (float *a, int *n, float *d);
 *
...
/* determ.f */
/**************/
float	determ_ (float *a, int *n, float *det);
