/*$Header: /data/petsun4/data1/src_solaris/paste_4dfp/RCS/paste_4dfp.c,v 1.10 2014/08/23 06:03:40 avi Exp $*/
/*$Log: paste_4dfp.c,v $
 * Revision 1.10  2014/08/23  06:03:40  avi
 * more generous filename buffers (MAXL 256 -> 1024)
 *
...
static char rcsid[] = "$Id: paste_4dfp.c,v 1.10 2014/08/23 06:03:40 avi Exp $";
...
/******************************/
	...
	if (k < 2) {
		...
		printf ("N.B.: in append mode, if frame count (third field in <inlist>) is blank, the default is all frames\n");
		exit (1);
	}
