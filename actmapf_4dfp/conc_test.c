/*$Header: /data/petsun4/data1/src_solaris/actmapf_4dfp/RCS/conc_test.c,v 1.5 2014/08/23 05:28:59 avi Exp $*/
/*$Log: conc_test.c,v $
 * Revision 1.5  2014/08/23  05:28:59  avi
 * make output test dependent on option -a
 *
...
/* global variables */
/********************/
static char	rcsid[] = "$Id: conc_test.c,v 1.5 2014/08/23 05:28:59 avi Exp $";
static char	program[MAXL];
static char	trailer[MAXL] = "";

void usage (char *program) {
	fprintf (stderr, "Usage:\t%s <concfile>\n", program);
	fprintf (stderr, "e.g.,\t%s test.conc\n", program);
	fprintf (stderr, "\t-a<str>\tspecify output concfile trailer (default no output)\n");
